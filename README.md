...
| Skill | What it helps with |
| --- | --- |
| [cursor-cli-delegation](skills/productivity/cursor-cli-delegation/) | Explicitly delegate planning, research, implementation, or review through Cursor Agent CLI with exact-model defaults, private evidence, and session follow-ups |
