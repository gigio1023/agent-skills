...
- A PR that changes behavior, structure, defaults, or data flow always gets an as-is/to-be table and a `technical-diagram` figure, with the as-is side read from the real base branch at the merge base; follow Before And After in pr-body-guidance.md.
