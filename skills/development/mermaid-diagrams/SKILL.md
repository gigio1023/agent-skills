...
- **Host version is part of correctness.** Markdown strings, `@{ shape: }`, ELK, and beta diagram types fail or degrade on pinned hosts (GitLab 11.4, mkdocs-material 10.x, Confluence plugins). Unknown host → version-safe subset.
