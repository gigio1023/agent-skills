...
- [ ] Required repository checks and applicable docstring, lint, or docs-build checks ran; type or runtime tests were added only for a specific claim or tool-sensitive change, rather than every prose edit.
...
Do not inflate a review with trivial private functions or style preferences that the repository does not enforce.
